  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return Vue.openBlock(), Vue.createElementBlock("div", {
        ...
        _ctx.breadcrumb ? (Vue.openBlock(), Vue.createBlock(Vue.unref(index_vue_vue_type_script_setup_true_name_ArticleBreadcrumb_lang.default), { key: 0 })) : Vue.createCommentVNode("v-if", true),
